#WEEK 6 DAY 1: Sequential Search - 2

#This second version of sequential search removes the repeated NOT FOUND messages by utilizing a 'found' variable to hold the found locations. The found variable is then checked to only display either the found searched-for record or a message reading it has not been found. THIS WILL ONLY EVER SHOW ONE FOUND ITEM (if found at all) 
