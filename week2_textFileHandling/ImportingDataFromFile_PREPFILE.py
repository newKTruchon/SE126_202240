...
#flip all '\' to '/'
with open("C:/Users/KTRUCHON\Desktop/SE126_202240/week2_textFileHandling/example.csv") as csvfile:
...
print("---------------------------------------------")
print("\n\tTOTAL RECORDS IN FILE: {0}".format(total_records))
print("\tTOTAL of all SALARIES: ${0:.2f}\n\n".format(total_salaries))